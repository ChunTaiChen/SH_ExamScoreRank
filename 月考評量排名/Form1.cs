...
namespace 月考評量排名
{
    public partial class frm1 : BaseForm
    {
        ...
        string ClassConfig_1 = "NumToChiChar.ExamSubj.cs.Form1.cs";
        ...
        private void SaveNow(Document inResult)
        {
            Document _inResult = inResult;
            ...
            try
            {
                ...
                SaveFileDialog1.FileName = "月考評量排名_獎狀(" + DateTime.Today.ToString("yyyyMMdd") + ")";

                if (SaveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    _inResult.Save(SaveFileDialog1.FileName, SaveFormat.Doc);
